...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/mojtabasadegh10/3xui-multi-protocol/master/install.sh --ipv4)
```
...
![image](https://github.com/mojtabasadegh10/3xui-multi-protocol/assets/61095662/196f9e7e-d248-4aed-940a-2ab8f9a13d95)
...
#حذف
```bash
bash <(curl -Ls https://raw.githubusercontent.com/mojtabasadegh10/3xui-multi-protocol/master/unistall.sh --ipv4)
```
